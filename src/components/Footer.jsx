    ...
    return (
       ...
       <div className="max-w-lg sm:mx-auto sm:text-center">
           ...
           <p className="leading-relaxed mt-2 text-[15px]">
               The leading turnkey fueling equipment solutions provider.we are determined to bring a new level of customer service to the retail petroleum service industry.
           </p>
       </div>
       ...
       <div className="mt-8 items-center justify-between sm:flex">
           <div className="mt-4 sm:mt-0">
               &copy; 2022 Mabden All rights reserved.
           </div>
